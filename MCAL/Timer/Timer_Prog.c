...
u32 Timer_U32_NumOfOverFlows_Timer_0 = 0;
u32 Timer_U32_NumOfOverFlows_Timer_2 = 0;
...
void M_Timer_Void_TimerSetTime(u8 Copy_U8_TimerChannel,
	...
	case TIMER0_CHANNEL:
#if TIMER0_MODE   ==   NORMAL_MODE
		Timer_U32_NumOfOverFlows_Timer_0 = Local_U32_TotalTicks / 256;
...
ISR(TIMER0_OVF_vect)
{
	...
	Local_U32_Counter++;
	if(Local_U32_Counter == Timer_U32_NumOfOverFlows_Timer_0)
	{
		Timer0_CallBack();
		TCNT0_REG = 256 - Timer_U8_RemTicks;
		Local_U32_Counter = 0;
